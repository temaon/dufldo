class NewsController < ApplicationController
  ...
  # GET /news.json
  def index
    render 'news_categories/show', locals: {object: @object, posts: @posts, decorated_posts: @decorated_posts, tags: @tags, categories: @categories, popular_news: @popular_news}
  end
  ...
  def show
    ...
    render 'news/show', locals: {news: @object, tags: @tags, categories: @categories, popular_news: @popular_news}
  end

  private

  def finder
    @object = News.finder(params[:id]).try(:first)
